        ...
        {isOpen && (
          ...
          >
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                <h3 className="font-black text-gray-900 leading-none">Повідомлення</h3>
                <p className="text-[10px] uppercase font-bold text-gray-400 mt-1 tracking-wider">
                  {unreadCount > 0 ? `${unreadCount} нових` : 'Все прочитано'}
                </p>
              </div>
              {unreadCount > 0 && (
                <button 
            ...
            <div className="max-h-[380px] overflow-y-auto">
              {loading ? (
                <div className="p-12 flex flex-col items-center justify-center gap-3 text-gray-300">
                  ...
                  <span className="text-[10px] uppercase font-bold tracking-widest">Завантаження...</span>
                </div>
              ) : error ? (
                <div className="p-8 text-center">
                   <p className="text-xs font-bold text-farm-berry uppercase tracking-tight">Помилка доступу</p>
                        ...
                        <div className="flex-1 min-w-0 pr-4">
                          <div className="flex items-center justify-between gap-2 mb-1">
                            ...
                            <span className="text-[9px] font-bold text-gray-400 whitespace-nowrap">
                              {n.createdAt?.toDate ? new Date(n.createdAt.toDate()).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'Щойно'}
                            </span>
                          </div>
                          ...
                          <div className="flex items-center gap-3 mt-3">
                            ...
                            {n.link && (
                              ...
                              >
                                Переглянути <ExternalLink className="w-2.5 h-2.5" />
                              </Link>
                            )}
                          </div>
                        </div>
                ...
                <div className="p-12 text-center">
                  ...
                  <p className="text-sm font-bold text-gray-400">Повідомлень немає</p>
                  <p className="text-[10px] text-gray-300 mt-1 uppercase tracking-tight">Ваш кабінет чистий</p>
                </div>
              )}
            </div>
