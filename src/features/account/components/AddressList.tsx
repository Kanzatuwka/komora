  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-3xl font-bold text-farm-green">Мої адреси</h2>
        <Button onClick={() => setIsAdding(true)} size="sm">Додати нову</Button>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {addresses.length === 0 && (
          <div className="md:col-span-2 bg-white/50 border-2 border-dashed border-farm-wood/10 p-12 rounded-[2.5rem] text-center">
            <p className="text-farm-wood opacity-50">Збережених адрес немає</p>
          </div>
        )}
      </div>
      ...
      <AnimatePresence>
        {isAdding && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <h2 className="text-2xl font-bold text-farm-green mb-8">Нова адреса</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-farm-wood mb-2 ml-4">Назва (напр. Дім, Робота)</label>
                  <input
                    type="text"
                    required
                    value={form.label}
                ...
                <div>
                  <label className="block text-sm font-medium text-farm-wood mb-2 ml-4">Вулиця, будинок</label>
                  <input
                    type="text"
                    required
                    value={form.street}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-farm-wood mb-2 ml-4">Індекс</label>
                    <input
                      type="text"
                      required
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Button type="button" variant="ghost" className="flex-1" onClick={() => setIsAdding(false)}>Скасувати</Button>
                </div>
              </form>
            </motion.div>
          </div>
        ...
        {isDeleting && (
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-farm-green mb-2">Видалити адресу?</h3>
              <p className="text-farm-wood opacity-50 mb-8">Цю дію неможливо скасувати.</p>
