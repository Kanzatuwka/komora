...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white p-8 rounded-[2.5rem] shadow-xl">
      <h2 className="text-3xl font-bold text-farm-green text-center mb-8">Вхід</h2>
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-farm-wood/50">або</span></div>
      </div>
      ...
      <p className="mt-8 text-center text-farm-wood/70 text-sm">
        Немає акаунту? <Link to="/register" className="text-farm-green font-bold hover:underline">Зареєструватися</Link>
      </p>
    </div>
  );
}
