...
> 🚀 **Проєкт запущено!** Наразі додаток працює в оточенні Google AI Studio і доступний для перегляду за посиланням: [**Демо-версія Komora**](https://ais-pre-u4vjlboq3xz7oo6kyduc5h-13883820133.europe-west2.run.app/)
